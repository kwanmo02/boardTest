			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row">
					...
					<div class="col-sm-8 blog-main">
						<div class="blog-post">
							<h2 class="blog-post-title">새 게시글 등록</h2>
							<hr>
							<form id="frm" class="form-signin" method="post" action="/createPosts" enctype="multipart/form-data">
...
<!-- 								<br> 글내용 <input type="text" name="content"
 ...
 -->								<!-- <br> 첨부파일 <input type="file" name="file"><br> -->
								...
								<button id="save" type="submit">게시글저장</button>
								<hr>
								<hr>
